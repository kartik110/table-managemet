...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::middleware(['auth','set_locale', 'has_permission', 'is_first_login'])->group(function () {
        ...
        Route::get('/daily-mapping', [DailyHistoryController::class, 'index'])->name('daily-mapping.index');
        Route::post('/daily-mapping', [DailyHistoryController::class, 'store'])->name('daily-mapping.store');
        Route::post('/daily-mapping/reset', [DailyHistoryController::class, 'reset'])->name('daily-mapping.reset');
