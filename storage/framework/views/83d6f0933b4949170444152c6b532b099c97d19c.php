...
unset($__errorArgs, $__bag); ?> integerchk"
                                        placeholder="<?php echo e(__('index.opening_balance')); ?>" value="<?php echo e(isset($obj) && $obj->opening_balance ? $obj->opening_balance : old('opening_balance')); ?>">
...
unset($__errorArgs, $__bag); ?> select2"
                                        ...
                                        <option value="Debit" <?php echo e(isset($obj) && $obj->opening_balance_type == 'Debit' || old('opening_balance_type') == 'Debit' ? 'selected' : ''); ?>><?php echo app('translator')->get('index.debit'); ?></option>
                                        <option value="Credit" <?php echo e(isset($obj) && $obj->opening_balance_type == 'Credit' || old('opening_balance_type') == 'Credit' ? 'selected' : ''); ?>><?php echo app('translator')->get('index.credit'); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('index.credit_limit'); ?></label>
...
unset($__errorArgs, $__bag); ?> integerchk"
                                    placeholder="<?php echo e(__('index.credit_limit')); ?>" value="<?php echo e(isset($obj) && $obj->credit_limit ? $obj->credit_limit : old('credit_limit')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('index.default_discount'); ?></label>
...
unset($__errorArgs, $__bag); ?> integerchkPercent"
                                    placeholder="<?php echo e(__('index.default_discount')); ?>" value="<?php echo e(isset($obj) && $obj->discount ? $obj->discount : old('discount')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('index.customer_type'); ?></label>
...
unset($__errorArgs, $__bag); ?> select2"
                                    ...
                                    <option value="Retail" <?php echo e(isset($obj) && $obj->customer_type || old('customer_type') == 'Retail' ? 'selected' : ''); ?>><?php echo app('translator')->get('index.retail'); ?></option>
                                    <option value="Wholesale" <?php echo e(isset($obj) && $obj->customer_type || old('customer_type') == 'Wholesale' ? 'selected' : ''); ?>><?php echo app('translator')->get('index.wholesale'); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('index.date_of_birth'); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="<?php echo e(__('index.date_of_birth')); ?>" autocomplete="off" value="<?php echo e(isset($obj) && $obj->date_of_birth ? $obj->date_of_birth : old('date_of_birth')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('index.date_of_anniversary'); ?></label>
                                <input type="text" name="date_of_anniversary" id="dates2"
                                    class="form-control <?php $__errorArgs = ['date_of_anniversary'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="<?php echo e(__('index.date_of_anniversary')); ?>" autocomplete="off" value="<?php echo e(isset($obj) && $obj->date_of_anniversary ? $obj->date_of_anniversary : old('date_of_anniversary')); ?>">
                                <?php $__errorArgs = ['date_of_anniversary'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/homebrew/var/www/iproduction/resources/views/pages/customer/addEditCustomer.blade.php ENDPATH**/ ?>