...
<section class="sidebar">
    ...
    <div id="left_menu_to_scroll">
        <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
            ...
            <?php endif; ?>
            <?php if(menuPermission('Table Mapping')): ?>
                <li
                    class="parent-menu treeview menu__cidirp_10<?php echo e(request()->is('tables*') || request()->is('history*') || request()->is('daily-mapping*') ? ' menu-open active_sub_menu' : ''); ?>">
                    <a href="#">
                        <iconify-icon icon="solar:chart-2-broken"></iconify-icon>
                        <span class="match_bold"><?php echo app('translator')->get('index.table'); ?></span>
                    </a>
                    
                    <ul class="treeview-menu">                        
                        <?php if(routePermission('tables.index')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('tables.index') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('tables.index')); ?>"><?php echo app('translator')->get('index.table'); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(routePermission('daily-mapping.index')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('daily-mapping.index') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('daily-mapping.index')); ?>"><?php echo app('translator')->get('index.tableMapping'); ?></a>
                            </li>
                        <?php endif; ?>               
                        <?php if(routePermission('history.index')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('history.index') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('history.index')); ?>"><?php echo app('translator')->get('index.tableHistory'); ?></a>
                            </li>
                        <?php endif; ?>               
                    </ul>
                </li>
...
<?php /**PATH /opt/homebrew/var/www/iproduction/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>