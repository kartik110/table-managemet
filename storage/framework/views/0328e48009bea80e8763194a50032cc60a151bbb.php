...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">
                            <div class="form-group">
                                <label for=""><?php echo app('translator')->get('index.table'); ?> <?php echo starSign(); ?></label>
...
unset($__errorArgs, $__bag); ?> select2">
                                    <option value=""><?php echo app('translator')->get('index.selecttable'); ?></option>
                                    <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($table->id); ?>"
                                            <?php echo e((isset($obj) && $obj->table_id == $table->id) || old('table_id') == $table->id ? 'selected' : ''); ?>>
                                            <?php echo e($table->name); ?> (<?php echo e($table->floor); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/homebrew/var/www/iproduction/resources/views/pages/user/addEdit.blade.php ENDPATH**/ ?>