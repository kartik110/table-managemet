                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_13_p"><?php echo app('translator')->get('index.name'); ?></th>
                                <th class="width_10_p"><?php echo app('translator')->get('index.contact_person'); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($value->contact_person ?? 'N/A'); ?></td>
                                    <td><?php echo e($value->phone ?? 'N/A'); ?></td>
                                    <td><?php echo e($value->email ?? 'N/A'); ?></td>
                                    <td><?php echo e(getAmtCustom($value->credit_limit)); ?></td>                                    
                                    <td><?php echo e(getAmtCustom($value->opening_balance)); ?></td>
                                    <td><?php echo e($value->opening_balance_type ?? 'N/A'); ?></td>
                                    <td><?php echo e($value->address ?? 'N/A'); ?></td>
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('supplier.edit')): ?>
                                            <a href="<?php echo e(url('suppliers')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit"
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('supplier.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('suppliers.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/homebrew/var/www/iproduction/resources/views/pages/supplier/suppliers.blade.php ENDPATH**/ ?>